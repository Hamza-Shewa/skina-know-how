      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-blue-600 block">Skina Business</span>
          </h2>
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            A comprehensive mobile application designed for managing beauty and
            sports service reservations. Digitally transform your service
            industry with simple, accessible, and convenient booking management.
          </p>
              ...
              <div className="p-6">
                <div className="flex items-start space-x-3">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-circle-check-big w-6 h-6 text-green-500 mt-1 flex-shrink-0"
                    aria-hidden="true"
                  >
                    <path d="M21.801 10A10 10 0 1 1 17 3.335"></path>
                    <path d="m9 11 3 3L22 4"></path>
                  ...
                  <p className="text-gray-700">
                    No subscription fees for using Skina Business App
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card text-card-foreground flex flex-col gap-6 rounded-xl border py-6 shadow-sm hover:shadow-lg transition-shadow">
              <div className="p-6">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-700">
                    Integration with Facebook, Instagram, Google
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of businesses already using Skina Business to manage
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-smartphone w-5 h-5 text-white"
                    aria-hidden="true"
                  >
                    <rect
                      width="14"
              ...
              <p className="text-gray-400">
                Digitally transforming the service industry with simple,
                accessible booking management.
              </p>
            </div>
            <div>
